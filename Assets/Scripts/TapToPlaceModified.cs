...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlaceModified : MonoBehaviour, IInputClickHandler
    {
            ...
            if (IsBeingPlaced)
            {
                ...
                if (Physics.Raycast(headPosition, gazeDirection, out hitInfo, 30.0f, spatialMappingManager.LayerMask))
                {
                    ...
                    if (PlaceParentOnTap)
                    {
                     ...
                     // original   Vector3 currentMovement = hitInfo.point - gameObject.transform.position;
                       ...
                       //test nope ParentGameObjectToPlace.GetComponent<Collider>().bounds.center.InverseTransformPoint += currentMovement;
