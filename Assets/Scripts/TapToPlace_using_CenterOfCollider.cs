...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlace_using_CenterOfCollider : MonoBehaviour, IInputClickHandler
    {
            ...
            if (IsBeingPlaced)
            {
                ...
                if (Physics.Raycast(headPosition, gazeDirection, out hitInfo, 30.0f, spatialMappingManager.LayerMask))
                {
                    ...
                    if (PlaceParentOnTap)
                    {
                        ...
                        // uses the Center of the Collider attached to the object, to place the Object in the World
                        // Works great with Plane Colliders at the position the Object should touch World Surfaces
                        Vector3 currentMovement = hitInfo.point - gameObject.GetComponent<Collider>().bounds.center; 
